...
;(function (window) {
    ...
    Slip.prototype = {
        ...
        slide : function (index) {
            ...
            picItems[prevIndex].style[vendor.transitionDuration] = '500ms';
            picItems[trueIndex-1].style[vendor.transitionDuration] = '500ms';
            picItems[nextIndex].style[vendor.transitionDuration] = '0ms';
        ...
        onTouchStart : function (e) {
            ...
            el.removeEventListener( TOUCH_EVENTS.move, that.onTouchMove, false );
            el.removeEventListener( TOUCH_EVENTS.end, that.onTouchEnd, false );
        ...
        onTouchMove : function (e) {
            ...
            el.removeEventListener( TOUCH_EVENTS.start, that.onTouchStart, false );
            el.removeEventListener( TOUCH_EVENTS.end, that.onTouchEnd, false );
            ...
            picItems[prevIndex].style[vendor.transform] = 'translate3d(' + moveDistance +'px,0,0)';
            picItems[trueIndex-1].style[vendor.transform] = 'translate3d(' + moveDistance + 'px,0,0)';
            picItems[nextIndex].style[vendor.transform] = 'translate3d(' + moveDistance + 'px,0,0)';
